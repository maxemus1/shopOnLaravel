<header class="main-header">
    ...
    <nav class="main-navigation">
        <ul class="nav-list">
            ...
            <li class="nav-list__item"><a href="{{route('orders.date')}}" class="nav-list__item__link">Мои заказы</a>
            </li>
        ...
        <div class="payment-container">
            <div class="payment-basket__status">
                <div class="payment-basket__status__icon-block">
                    <a href="{{route('cart.step')}}" class="payment-basket__status__icon-block__link">
